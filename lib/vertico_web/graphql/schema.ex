defmodule VerticoWeb.GraphQL.Schema do
  @moduledoc """
  ...
  alias Vertico.Auth.Authorization
  alias VerticoWeb.GraphQL.Middlewares.SafeResolver

  import_types Absinthe.Plug.Types
  import_types Absinthe.Type.Custom

  import_types VerticoWeb.GraphQL.{
    Accounts.UserSchema,
    Version,
  }
